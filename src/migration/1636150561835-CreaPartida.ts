...
export class CreaPartida1636150561835 implements MigrationInterface {
    name = 'CreaPartida1636150561835'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`aposta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`usuarioId\` int NOT NULL, \`partidaId\` int NOT NULL, \`placarMandante\` int NOT NULL, \`placarVisitante\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
