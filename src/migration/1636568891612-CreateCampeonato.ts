...
export class CreateCampeonato1636568891612 implements MigrationInterface {
    name = 'CreateCampeonato1636568891612'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`nome\` \`nome\` varchar(255) NOT NULL DEFAULT 'Campeonato'`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`slug\` \`slug\` varchar(255) NOT NULL DEFAULT '-'`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`logo\` \`logo\` varchar(255) NOT NULL DEFAULT '-'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`rodada\` ADD CONSTRAINT \`FK_d2f8c30f140114e3bd1a3c57221\` FOREIGN KEY (\`campeonatoId\`) REFERENCES \`campeonato\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`logo\` \`logo\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`slug\` \`slug\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`nome\` \`nome\` varchar(255) NOT NULL`);
