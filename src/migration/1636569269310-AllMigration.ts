...
export class AllMigration1636569269310 implements MigrationInterface {
    name = 'AllMigration1636569269310'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`status\` \`status\` varchar(255) NOT NULL DEFAULT '-'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`rodada\` ADD CONSTRAINT \`FK_d2f8c30f140114e3bd1a3c57221\` FOREIGN KEY (\`campeonatoId\`) REFERENCES \`campeonato\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`campeonato\` CHANGE \`status\` \`status\` varchar(255) NOT NULL`);
