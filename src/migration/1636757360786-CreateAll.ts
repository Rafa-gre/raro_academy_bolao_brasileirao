...
export class CreateAll1636757360786 implements MigrationInterface {
    name = 'CreateAll1636757360786'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`partida\` ADD \`mandanteId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`partida\` ADD \`visitanteId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`partida\` DROP COLUMN \`visitanteId\``);
        await queryRunner.query(`ALTER TABLE \`partida\` DROP COLUMN \`mandanteId\``);
    }
